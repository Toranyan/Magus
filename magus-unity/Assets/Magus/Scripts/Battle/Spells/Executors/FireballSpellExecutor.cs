...
namespace magus.battle.spells.executors
{
    public class FireballSpellExecutor : ISpellExecutor
    {
        ...
        private async UniTaskVoid ExecuteAsync(SpellCastContext context)
        {
            ...
            // TODO: set elemental damage type on projectile (requires DamageType.Fire etc.)
            // TODO: handle IsCounter — modify behaviour (e.g. reflect, apply Burning counter outcome)
        }
    }
}
